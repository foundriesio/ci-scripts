...
DEV_MODE="${DEV_MODE-0}"
APP_PRELOAD_LOG_FILE="${APP_PRELOAD_LOG_FILE-${archive}/app-preload.log}"
...
APP_PRELOAD_LOG_FILE = "${APP_PRELOAD_LOG_FILE}"
APP_PRELOAD_WITHIN_OE_BUILD = "${APP_PRELOAD_WITHIN_OE_BUILD}"
APP_SHORTLIST = "${APP_SHORTLIST}"
APP_PRELOADER = "PYTHONPATH=${HERE}/../ ${HERE}/preload_apps.py"
APP_PRELOAD_TOKEN_FILE = "${APP_PRELOAD_TOKEN_FILE}"
